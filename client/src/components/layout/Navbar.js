          ...
          <div class="overflow-y-auto">
            ...
            <ul class="">
              ...
              <PageButton id="notifications" url="/notifications" icon={
                <svg
                class="h-7 w-14" width="24" height="24" viewBox="-5 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
function PageButton(props) {
  return (
    <li class="hover:bg-yellow-400 hover:text-blue-900">
      <a
        href={props.url}
        class="h-16 px-5 justify-center items-center w-full	focus:text-gray-100">
        {props.icon}
      </a>
    </li>
  )
